#
#  Be sure to run `pod spec lint JBCoreDataAgent.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # s.authors      = { "Jeremy Bueler" => "jbueler@gmail.com", "other author" => "email@address.com" }
  # s.author       = 'Jeremy Bueler', 'other author'
  ...
  s.source       = { :git => "https://github.com/jbueler/JBCoreDataAgent", :tag => "0.0.1" }
